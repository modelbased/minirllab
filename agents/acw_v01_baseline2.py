...
'''
    ...
    Baseline1 -> Baseline2
    - Split Actor and Critic into separate nn.module classes
    - Added plasticity loss metrics logging
'''
...
class Agent:
    def __init__(self, obs_dim, action_dim, num_steps=8192, num_env=1, device='cpu', seed=42):
        ...
        # Make global
        self.name           = "acw_v01_baseline2"       # name for logging
    ...
    def update(self):
        ...
        b_obs = self.replay_buffer.get_obs()
