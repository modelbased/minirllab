...
def log_scalars(writer, agent, step):
    ...
    if hasattr(agent, "qf1_dormant_ratio")  : writer.add_scalar("plasticity/qf1_dormant_ratio", agent.qf1_dormant_ratio, step)
    if hasattr(agent, "qf2_dormant_ratio")  : writer.add_scalar("plasticity/qf2_dormant_ratio", agent.qf2_dormant_ratio, step)
    if hasattr(agent, "actor_dormant_ratio"): writer.add_scalar("plasticity/actor_dormant_ratio", agent.actor_dormant_ratio, step)
